...
FOOTPRINTS_SPECS: dict[str, FootprintSpecs] = {
    ...
    "LED_GREEN_0603_1608Metric": FootprintSpecs(
        body_dimensions=BodyDimensions(width=2.8, height=1.2),
        pad_dimensions=PadDimensionsAsymmetric(
            cathode_width=0.8,
            cathode_height=0.8,
            cathode_center_x=0.825,
            anode_width=0.8,
            anode_height=0.8,
            anode_center_x=0.825,
        ),
        ref_offset_y=-1.27,
    ),
    ...
    "SOD323F": FootprintSpecs(
        body_dimensions=BodyDimensions(width=3.2, height=1.4),
        pad_dimensions=PadDimensionsAsymmetric(
            cathode_width=0.6,
            cathode_height=0.6,
            cathode_center_x=1.1,
            anode_width=0.6,
            anode_height=0.6,
            anode_center_x=1.1,
        ),
