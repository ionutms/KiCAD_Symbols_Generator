...
EATON_ELECTRONICS_SYMBOLS_SPECS = {
    "HV0810-2R7": SeriesSpec(
        ...
        value_range={"Supercapacitor": (1, 16)},
        specified_values=[1, 3, 5, 6, 10, 15, 16],
        additional_values=[3, 5, 6, 16],
        value_footprints={
            ...
            16.0: "capacitor_footprints:C_295x630_H28_4_5_0x10Metric",
        },
        value_case_codes_in={
            1.0: "138x315_H13_5",
            3.0: "138x315_H21",
        ...
        value_3d_models={
            ...
            16.0: "capacitor_3d_models:C_295x630_H28_4",
        },
