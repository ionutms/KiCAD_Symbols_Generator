...
MURATA_SYMBOLS_SPECS = {
    ...
    "GCJ188R71H": SeriesSpec(
        manufacturer="Murata Electronics",
        mpn_prefix="GCJ188R71H",
        value_range={"X7R": (1e-9, 220e-9)},
        tolerance_map={"X7R": {"K": "10%"}},
        characteristic_codes={1e-9: "A01", 32e-9: "A12", 149e-9: "A01"},
        mpn_sufix=["D"],
        footprint="capacitor_footprints:C_0603_1608Metric",
        voltage_rating="50V",
        case_code_in="0603",
...
WURTH_ELEKTRONIK_SYMBOLS_SPECS = {
    ...
    "851617031001": SeriesSpec(
        ...
        value_footprints={100: "capacitor_footprints:C_22x45_10x10Metric"},
