"""Specifications for dip switches footprints.

This module defines the physical dimensions and parameters needed to generate
KiCad footprints for various dip switches. It provides structured data
...
class FootprintSpecs(NamedTuple):
    """Complete specifications for generating a dip switch footprint.
...
TACTILE_SWITCHES_SPECS: dict[str, FootprintSpecs] = {
    **{
        f"4161311608{switches_number}": FootprintSpecs(
            model_name=f"4161311608{switches_number}",
            pad_pitch=1.27,
            row_pitch=7.62,
            number_of_rows=2,
            body_dimensions=BodyDimensions(
