...
YAGEO_SYMBOLS_SPECS: Final[dict[str, SeriesSpec]] = {
    ...
    "RT0805BRD07": SeriesSpec(
        ...
        extra_values=[
            13.5, 25, 29.8, 39.7, 43.7, 44.8, 49.3, 50.5, 59.7, 92, 109, 167,
            246, 248, 320, 328, 388, 505, 690, 723, 835, 1290, 1450, 1520,
            1760, 1890, 1980, 2180, 2230, 2340, 2640, 3050, 3120, 3200, 3790,
            4480, 4810, 5050, 5200, 5420, 6260, 6730, 6890, 7230, 8160, 8560,
            8980, 9200, 9420, 10100, 10400, 10900, 11100, 11700, 12300, 14500,
            14900, 17200, 20300, 21300, 21800, 27100, 27700, 30500, 31200,
            32000, 33600, 36100, 37900, 38800, 39700, 40700, 41700, 42700,
            43700, 44800, 45900, 48100, 49300, 51700, 58300, 62600, 75900,
            79600, 81600, 85600, 87600, 89800, 92000, 101000, 109000, 111000,
            135000, 142000, 145000, 164000, 172000, 176000, 203000, 223000,
            252000, 271000, 277000, 305000, 352000, 397000, 459000, 723000,
            942000, 1170000, 1490000],
        tolerance_map={"E96": "0.1%", "E24": "0.1%"},
        datasheet=(
            "https://www.yageo.com/en/ProductSearch/"
            "PartNumberSearch?part_number="),
    ...
    "RT0805DRE07": SeriesSpec(
        ...
        resistance_range=[1, 1_500_000],
        extra_values=[
            30.5, 176, 234, 305, 597, 741, 759, 777, 796, 816, 835, 876, 920,
            942, 965, 988, 1010, 2230, 5050, 7060, 11100, 14500, 15600, 17600,
            20300, 21300, 27100, 44800, 101000, 417000],
        excluded_values=[
            1.02, 1.05, 1.07, 1.1, 1.13, 1.15, 1.18, 1.2, 1.21, 1.24, 1.27,
            1.3, 1.33, 1.37, 1.4, 1.43, 1.47, 1.5, 1.54, 1.58, 1.6, 1.62,
            1.65, 1.69, 1.74, 1.78, 1.8, 1.82, 1.87, 1.91, 1.96, 2.26, 2.32,
            2.37, 2.4, 2.49, 2.55, 2.61, 2.67, 2.7, 2.74, 2.8, 2.87, 2.94,
            3.09, 3.16, 3.24, 3.3, 3.32, 3.4, 3.48, 3.57, 3.6, 3.65, 3.74,
            3.83, 3.92, 4.12, 4.22, 4.3, 4.32, 4.42, 4.53, 4.64, 4.75, 4.87,
            5.11, 5.23, 5.36, 5.49, 5.62, 5.76, 5.9, 6.19, 6.34, 6.49, 6.65,
            6.98, 7.15, 7.32, 7.68, 7.87, 8.25, 8.45, 8.66, 8.87, 9.09, 9.31,
            9.53, 9.76, 10.2, 10.7, 11.3, 11.5, 11.8, 12.7, 13.3, 13.7, 14.7,
            15.4, 15.8, 16.5, 17.8, 18.7, 20.5, 21, 23.7, 24.3, 25.5, 26.7,
            28, 30.9, 31.6, 35.7, 41.2, 43.2, 44.2, 46.4, 53.6, 59, 71.5,
            73.2, 76.8, 84.5, 88.7, 95.3, 97.6, 105, 107, 137, 215, 226, 316,
            365, 392, 536, 820, 910, 1180, 1650, 1870, 5760, 11300, 14700,
            37400, 53600, 60400, 118000, 124000, 160000, 210000, 261000,
            309000, 357000, 412000, 422000, 442000, 536000, 549000, 562000,
            620000, 698000, 715000, 732000, 768000, 787000, 845000, 976000,
            1020000, 1050000, 1070000, 1100000, 1150000, 1180000, 1200000,
            1210000, 1240000, 1270000, 1300000, 1330000, 1370000, 1400000,
            1430000, 1470000],
    ...
    "RC0402FR-7W": SeriesSpec(
        ...
        resistance_range=[1, 10_000_000],
        specified_values=[
            1, 1.2, 1.5, 1.8, 2.2, 2.4, 2.7, 3.6, 4.7, 4.75, 5.6, 10, 12,
            12.1,18, 20, 22, 23.2, 27, 29.4, 30.1, 33, 34, 36, 37.4, 39, 43,
            44.2, 45.3, 47, 49.9, 52.3, 56, 62, 71.5, 75, 80.6, 82, 90.9,
            95.3, 97.6, 100, 110, 120, 121, 127, 130, 140, 143, 150, 162, 174,
            180, 182, 187, 200, 210, 220, 221, 240, 243, 270, 300, 301, 316,
            330, 365, 390, 392, 402, 422, 470, 475, 499, 510, 560, 604, 620,
            649, 665, 680, 750, 806, 820, 910, 1000, 1020, 1050, 1100, 1180,
            1200, 1210, 1240, 1300, 1400, 1500, 1600, 1690, 1780, 1800, 1820,
            1870, 1910, 2000, 2100, 2200, 2210, 2400, 2490, 2700, 3000, 3090,
            3300, 3480, 3570, 3600, 3650, 3830, 3900, 4020, 4120, 4300, 4320,
            4530, 4700, 4750, 4990, 5100, 5600, 5620, 5760, 5900, 6040, 6190,
            6200, 6340, 6490, 6800, 7320, 7500, 7870, 8060, 8200, 8660, 9090,
            9100, 9310, 10000, 10200, 10700, 11800, 12000, 12100, 12700,
            13000, 14700, 15000, 15800, 16000, 18000, 20000, 21000, 21500,
            22000, 22100, 24000, 24300, 24900, 25500, 26100, 27000, 27400,
            28000, 29400, 30100, 33000, 33200, 34000, 36000, 36500, 38300,
            39000, 39200, 40200, 41200, 42200, 46400, 47000, 47500, 49900,
            51000, 51100, 53600, 56000, 56200, 57600, 59000, 60400, 61900,
            62000, 64900, 68000, 68100, 69800, 71500, 75000, 76800, 82000,
            86600, 91000, 93100, 97600, 100000, 110000, 115000, 120000,
            130000, 133000, 137000, 140000, 143000, 150000, 154000, 169000,
            180000, 187000, 196000, 200000, 220000, 232000, 237000, 240000,
            249000, 270000, 294000, 300000, 316000, 324000, 330000, 360000,
            365000, 432000, 442000, 470000, 475000, 510000, 536000, 560000,
            590000, 680000, 750000, 820000, 845000, 866000, 910000, 1000000,
    ...
    "RT0402FRE07": SeriesSpec(
        ...
        excluded_values=[
            4.75, 4.87, 5.23, 5.36, 5.49, 5.62, 5.76, 5.9, 6.04, 6.19, 6.34,
            6.49, 6.65, 6.81, 6.98, 7.15, 7.32, 7.68, 7.87, 8.06, 8.25, 8.45,
            8.66, 8.87, 9.09, 9.31, 9.53, 9.76, 10.7, 11.3, 11.8, 12.4, 15.8,
            17.4, 19.1, 21, 23.2, 25.5, 28, 35.7, 41.2, 45.3, 52.3, 54.9,
            57.6, 73.2, 76.8, 88.7, 97.6, 118, 137, 232, 324, 732, 768, 845,
            1070, 1370, 6980, 7680, 45300, 102000, 113000, 124000, 127000,
            158000, 169000, 191000, 237000, 243000, 249000, 255000, 261000,
    ...
    "RT0603FRE07": SeriesSpec(
        ...
        excluded_values=[
            1.02, 1.05, 1.07, 1.13, 1.15, 1.18, 1.2, 1.21, 1.24, 1.27, 1.3,
            1.33, 1.37, 1.4, 1.43, 1.54, 1.58, 1.6, 1.62, 1.65, 1.69, 1.74,
            1.78, 1.87, 1.91, 1.96, 2.05, 2.1, 2.15, 2.26, 2.32, 2.37, 2.4,
            2.43, 2.61, 2.67, 2.74, 2.8, 2.87, 2.94, 3.09, 3.16, 3.24, 3.4,
            3.48, 3.57, 3.74, 4.02, 4.12, 4.42, 4.53, 4.87, 5.23, 5.36, 5.49,
            5.9, 6.04, 6.19, 6.34, 6.49, 6.65, 7.15, 7.32, 7.68, 7.87, 8.06,
            8.45, 8.87, 9.09, 9.31, 9.76, 10.5, 11.5, 12.4, 12.7, 13.3, 15.8,
            16.9, 19.1, 20.5, 23.2, 26.7, 28, 28.7, 29.4, 30.9, 32.4, 48.7,
            57.6, 66.5, 69.8, 73.2, 76.8, 84.5, 93.1, 97.6, 102, 107, 115,
            255, 280, 845, 52300, 715000, 732000, 768000, 787000, 845000,
            887000, 909000, 931000, 976000, 1020000, 1050000, 1070000,
            1100000, 1130000, 1150000, 1180000, 1200000, 1210000, 1240000,
            1270000, 1300000, 1330000, 1370000, 1400000, 1430000, 1470000,
            1500000, 1540000, 1580000, 1600000, 1620000, 1650000, 1690000,
            1740000, 1780000, 1800000, 1820000, 1870000, 1910000, 1960000,
            2000000],
        tolerance_map={"E96": "1%", "E24": "1%"},
        datasheet=(
            "https://www.yageo.com/en/ProductSearch/"
