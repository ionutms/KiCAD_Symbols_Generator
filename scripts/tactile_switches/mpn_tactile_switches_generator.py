...
Generates part numbers and specifications for tactile switches series.
...
import footprint_tactile_switches_generator
import symbol_tactile_switches_generator as symbol_tactile_switches_generator
...
def generate_files_for_series(
    ...
    specs = symbol_tactile_switches_specs.SYMBOLS_SPECS[series_name]
    ...
    footprint_dir = "footprints/tactile_switches_footprints.pretty"
    ...
    symbol_filename = f"TACTILE_SWITCHES_{series_code}_DATA_BASE.kicad_sym"

    # Generate part numbers and write to CSV
    parts_list = symbol_tactile_switches_specs.PartInfo.generate_part_numbers(
        specs
    )
    ...
    try:
        symbol_tactile_switches_generator.generate_kicad_symbol(
            csv_path,
...
def generate_unified_files(
    all_parts: list[symbol_tactile_switches_specs.PartInfo],
    unified_csv: str,
    unified_symbol: str,
) -> None:
...
if __name__ == "__main__":
    try:
        ...
        UNIFIED_SYMBOL = "UNITED_TACTILE_SWITCHES_DATA_BASE.kicad_sym"
