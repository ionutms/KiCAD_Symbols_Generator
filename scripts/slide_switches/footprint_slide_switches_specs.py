"""Specifications for slide switches footprints.

This module defines the physical dimensions and parameters needed to generate
KiCad footprints for various slide switches. It provides structured data
...
class FootprintSpecs(NamedTuple):
    """Complete specifications for generating a slide switch footprint.
