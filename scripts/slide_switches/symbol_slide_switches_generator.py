"""KiCad Slide Switch Symbol Generator.

Generates KiCad symbol files for slide switches from CSV data.
...
from symbol_slide_switches_specs import SYMBOLS_SPECS
...
def generate_kicad_symbol(
    ...
    """Generate a KiCad symbol file from CSV data for slide switches.
...
def write_component(
    ...
    symbol_utils.write_slide_switch_symbol_drawing(
