...
PADS_16 = [
    (
        [1, 2, 3, 4, 5, 6, 7, 8],
        0,
        [-8.89, -6.35, -3.81, -1.27, 1.27, 3.81, 6.35, 8.89],
        {},
    ),
    (
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        pad_positions_override=[
            *make_pad_group(PADS_32_4PWR, pad_base=0, x_offset=-23.4),
            *make_pad_group(PADS_32_4PWR, pad_base=32, x_offset=0.0),
            *make_pad_group(PADS_14_4PWR, pad_base=64, x_offset=23.4),
        ],
        pad1_square=False,
    )
    for mpn in ["2005063001", "2005063501"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        ref_y=14.986,
        pad_positions_override=[
            *make_pad_group(PADS_14_4PWR, pad_base=0, x_offset=-35.1),
            *make_pad_group(PADS_32_4PWR, pad_base=28, x_offset=-11.7),
            *make_pad_group(PADS_28_7PWR, pad_base=56, x_offset=11.7),
            *make_pad_group(PADS_14_4PWR, pad_base=84, x_offset=35.1),
        ],
        pad1_square=False,
    )
    for mpn in ["2005064008", "2005064508"]
}
...
CONNECTOR_SPECS |= {
    ...
    for mpn in ["2005063008", "2005063508"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        pad_positions_override=[
            *make_pad_group(PADS_25_4PWR, pad_base=0, x_offset=-23.4),
            *make_pad_group(PADS_32_4PWR, pad_base=25, x_offset=0.0),
            *make_pad_group(PADS_32_4PWR, pad_base=57, x_offset=23.4),
        ],
        pad1_square=False,
    )
    for mpn in ["2005063012", "2005063512"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        pad_positions_override=[
            *make_pad_group(PADS_32_4PWR, pad_base=0, x_offset=-23.4),
            *make_pad_group(PADS_28_7PWR, pad_base=28, x_offset=0.0),
            *make_pad_group(PADS_32_4PWR, pad_base=60, x_offset=23.4),
        ],
        pad1_square=False,
    )
    for mpn in ["2005063006", "2005063506"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        pad_positions_override=[
            *make_pad_group(PADS_32_4PWR, pad_base=0, x_offset=-23.4),
            *make_pad_group(PADS_32_4PWR, pad_base=32, x_offset=0.0),
            *make_pad_group(PADS_32_4PWR, pad_base=64, x_offset=23.4),
        ],
        pad1_square=False,
    )
    for mpn in ["2005063007", "2005063507"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        ref_y=14.986,
        pad_positions_override=[
            *make_pad_group(PADS_28_7PWR, pad_base=0, x_offset=-35.1),
            *make_pad_group(PADS_28_7PWR, pad_base=28, x_offset=-11.7),
            *make_pad_group(PADS_28_7PWR, pad_base=56, x_offset=11.7),
            *make_pad_group(PADS_25_4PWR, pad_base=84, x_offset=35.1),
        ],
        pad1_square=False,
    )
    for mpn in ["2005064006", "2005064506"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        ref_y=14.986,
        pad_positions_override=[
            *make_pad_group(PADS_32_4PWR, pad_base=0, x_offset=-58.5),
            *make_pad_group(PADS_14_4PWR, pad_base=32, x_offset=-35.1),
            *make_pad_group(PADS_14_4PWR, pad_base=44, x_offset=-11.7),
            *make_pad_group(PADS_14_4PWR, pad_base=56, x_offset=11.7),
            *make_pad_group(PADS_25_4PWR, pad_base=68, x_offset=35.1),
            *make_pad_group(PADS_25_4PWR, pad_base=93, x_offset=58.5),
        ],
        pad1_square=False,
    )
    for mpn in ["2005066002", "2005066502"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        ref_y=14.986,
        pad_positions_override=[
            *make_pad_group(PADS_32_4PWR, pad_base=0, x_offset=-35.1),
            *make_pad_group(PADS_32_4PWR, pad_base=32, x_offset=-11.7),
            *make_pad_group(PADS_32_4PWR, pad_base=64, x_offset=11.7),
            *make_pad_group(PADS_32_4PWR, pad_base=96, x_offset=35.1),
        ],
        pad1_square=False,
    )
    for mpn in ["2005064004", "2005064504"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        pad_positions_override=[
            *make_pad_group(PADS_14_4PWR, pad_base=0, x_offset=-58.5),
            *make_pad_group(PADS_28_7PWR, pad_base=12, x_offset=-35.1),
            *make_pad_group(PADS_23_2PWR, pad_base=40, x_offset=-11.7),
            *make_pad_group(PADS_23_2PWR, pad_base=63, x_offset=11.7),
            *make_pad_group(PADS_23_2PWR, pad_base=86, x_offset=35.1),
            *make_pad_group(PADS_23_2PWR, pad_base=109, x_offset=58.5),
        ],
        pad1_square=False,
    )
    for mpn in ["2005066006", "2005066506"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        ref_y=14.986,
        pad_positions_override=[
            *make_pad_group(PADS_32_4PWR, pad_base=0, x_offset=-46.8),
            *make_pad_group(PADS_32_4PWR, pad_base=32, x_offset=-23.4),
            *make_pad_group(PADS_25_4PWR, pad_base=64, x_offset=0.0),
            *make_pad_group(PADS_25_4PWR, pad_base=89, x_offset=23.4),
            *make_pad_group(PADS_25_4PWR, pad_base=114, x_offset=46.8),
        ],
        pad1_square=False,
    )
    for mpn in ["2005065003", "2005065503"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        ref_y=14.986,
        pad_positions_override=[
            *make_pad_group(PADS_25_4PWR, pad_base=0, x_offset=-46.8),
            *make_pad_group(PADS_27_8PWR, pad_base=32, x_offset=-23.4),
            *make_pad_group(PADS_27_8PWR, pad_base=64, x_offset=0.0),
            *make_pad_group(PADS_32_4PWR, pad_base=89, x_offset=23.4),
            *make_pad_group(PADS_32_4PWR, pad_base=114, x_offset=46.8),
        ],
        pad1_square=False,
    )
    for mpn in ["2005065005", "2005065505"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        pad_positions_override=[
            *make_pad_group(PADS_25_4PWR, pad_base=0, x_offset=-46.8),
            *make_pad_group(PADS_25_4PWR, pad_base=32, x_offset=-23.4),
            *make_pad_group(PADS_32_4PWR, pad_base=64, x_offset=0.0),
            *make_pad_group(PADS_32_4PWR, pad_base=89, x_offset=23.4),
            *make_pad_group(PADS_32_4PWR, pad_base=114, x_offset=46.8),
        ],
        pad1_square=False,
    )
    for mpn in ["2005065006", "2005065506"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        ref_y=14.986,
        pad_positions_override=[
            *make_pad_group(PADS_27_8PWR, pad_base=0, x_offset=-58.5),
            *make_pad_group(PADS_32_4PWR, pad_base=12, x_offset=-35.1),
            *make_pad_group(PADS_28_7PWR, pad_base=40, x_offset=-11.7),
            *make_pad_group(PADS_25_4PWR, pad_base=63, x_offset=11.7),
            *make_pad_group(PADS_32_4PWR, pad_base=86, x_offset=35.1),
            *make_pad_group(PADS_28_7PWR, pad_base=109, x_offset=58.5),
        ],
        pad1_square=False,
    )
    for mpn in ["2005066001", "2005066501"]
}
...
CONNECTOR_SPECS |= {
    ...
    for mpn in [
        *["346910080", "346916080", "346919080", "346919680"],
        *["346910082", "346916082", "346919082", "346919682"],
        *["346910081", "346916081", "346919081", "346919681"],
    ]
}
...
CONNECTOR_SPECS |= {
    ...
    for mpn in [
        *["346960100", "346969100", "346960102", "346969102"],
        *["346960101", "346969101"],
    ]
}
...
CONNECTOR_SPECS |= {
    ...
    for mpn in [
        *["346910120", "346916120", "346919120", "346919623"],
        *["346910122", "346919122", "346916122", "346919625"],
        *["346910121", "346916121", "346919121", "346919624"],
    ]
}
...
CONNECTOR_SPECS |= {
    ...
    for mpn in [
        *["347730140", "347731140", "347738140", "347739140"],
        *["347730142", "347731142", "347738142", "347739142"],
        *["347730141", "347731141", "347738141", "347739141"],
    ]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        ref_y=5.842,
        pad_positions_override=[
            *make_pad_group(PADS_16, pad_base=0, x_offset=0.0),
        ],
        pad1_square=False,
    )
    for mpn in [
        *["346910160", "346916160", "346919160"],
        *["346910162", "346916162", "346919162", "346919662"],
        *["346910161", "346916161", "346919161", "346919661"],
    ]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        ref_y=5.842,
        pad_positions_override=[
            *make_pad_group(PADS_8, pad_base=0, x_offset=-8.8),
            *make_pad_group(PADS_8, pad_base=8, x_offset=8.8),
        ],
        pad1_square=False,
    )
    for mpn in ["347082009"]
}
...
CONNECTOR_SPECS |= {
    ...
    for mpn in ["346910200", "346916200", "346919200", "346919246"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        ref_y=5.842,
        pad_positions_override=[
            *make_pad_group(PADS_10_4PWR, pad_base=0, x_offset=-16.4),
            *make_pad_group(PADS_12, pad_base=10, x_offset=11.4),
        ],
        pad1_square=False,
    )
    for mpn in ["347082010"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        pad_positions_override=[
            *make_pad_group(PADS_8, pad_base=0, x_offset=-8.8),
            *make_pad_group(PADS_16, pad_base=8, x_offset=13.95),
        ],
        pad1_square=False,
    )
    for mpn in ["347082028"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        pad_positions_override=[
            ...
            *make_pad_group(PADS_10_4PWR, pad_base=16, x_offset=16.5),
        ],
        pad1_square=False,
    )
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        pad_positions_override=[
            ...
            *make_pad_group(PADS_10_4PWR, pad_base=20, x_offset=16.5),
        ],
        pad1_square=False,
    )
    for mpn in ["347082012"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        ref_y=5.842,
        pad_positions_override=[
            *make_pad_group(PADS_12, pad_base=0, x_offset=-11.4),
            *make_pad_group(PADS_20, pad_base=12, x_offset=16.4),
        ],
        pad1_square=False,
    )
    for mpn in ["347082019"]
}
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        pad_positions_override=[
            *make_pad_group(PADS_20, pad_base=0, x_offset=-16.4),
            *make_pad_group(PADS_16, pad_base=20, x_offset=13.85),
        ],
        pad1_square=False,
    )
...
CONNECTOR_SPECS |= {
    mpn: FootprintSpecs(
        ...
        ref_y=5.842,
        pad_positions_override=[
            *make_pad_group(PADS_12, pad_base=0, x_offset=-25.4),
            *make_pad_group(PADS_16, pad_base=12, x_offset=0),
            *make_pad_group(PADS_16, pad_base=28, x_offset=27.7),
        ],
        pad1_square=False,
    )
    for mpn in ["347083000"]
}
