...
CONNECTOR_SPECS: dict[str, FootprintSpecs] = {
    ...
    "1600130623": FootprintSpecs(
        ...
        pad_positions_override=[
            ...
            *[
                PadPosition(
                    pad_number=str(row * 14 + col + 1), x=x, y=row * 3
                )
                for row in range(3)
            ...
            *[
                ...
                for n, x in zip(
                    range(43, 49), [-15.74, -7.74, -3.74, 3.74, 11.74, 15.74]
                )
            ],
            # Row 5
            *[
    ...
    "1600131624": FootprintSpecs(
        ...
        pad_positions_override=[
            # Row 1
            *[
                PadPosition(pad_number=str(col + 1), x=x, y=0)
                for col, x in enumerate([
                    *[-15.74, -13.74, -11.74, -9.74, -7.74, -5.74, -3.74],
                    *[3.74, 5.74, 7.74, 9.74, 11.74, 13.74, 15.74],
                ])
            ...
            # Row 2
            *[
                PadPosition(pad_number=str(14 + col + 1), x=x, y=6)
                for col, x in enumerate([
                    *[-15.74, -13.74, -11.74, -9.74, -7.74, -5.74, -3.74],
                ])
            ],
            ...
            *[
                ...
                for n, x in zip(range(22, 25), [3.74, 11.74, 15.74])
            ],
            # Row 4
            *[
                PadPosition(
    ...
    "2005020251": FootprintSpecs(
        ...
        pad_positions_override=[
            ...
            *[
                PadPosition(
                    pad_number=str(n), x=x, y=6, pad_size=1.5, drill_size=1.1
                )
                for n, x in zip(
                    range(5, 12), [-6.6, -4.6, -2.6, 0.6, 2.6, 4.6, 6.6]
                )
            ],
            # Row 4
            *[
                PadPosition(
                    pad_number=str(n), x=x, y=9, pad_size=1.5, drill_size=1.1
                )
                for n, x in zip(
                    range(12, 20), [-6.6, -4.6, -2.6, 0.6, 2.6, 4.6, 6.6]
                )
            ],
            # Row 5
            *[
                PadPosition(
                    pad_number=str(n), x=x, y=12, pad_size=1.5, drill_size=1.1
                )
                for n, x in zip(
                    range(19, 26), [-6.6, -4.6, -2.6, 0.6, 2.6, 4.6, 6.6]
                )
            ],
        ],
        pad1_square=False,
    ),
    "2005020252": FootprintSpecs(
        show_pin1_indicator=False,
        pad_pitch=3.54,
        body_dimensions=BodyDimensions(
            width_left=14, width_right=14, height_top=28, height_bottom=14
