...
SYMBOLS_SPECS: dict[str, SeriesSpec] = {
    ...
    "744393605": SeriesSpec(
        ...
        datasheet="https://www.we-online.com/components/products/datasheet/",
        inductance_values=[
            *[0.22, 0.68, 1, 1.5, 2.2, 3.3, 4.7, 5.6, 6.8, 8.2, 10, 15, 22],
        ],
        max_dc_current=[
            *[45.6, 41.9, 29.5, 28.7, 27.9, 25.2, 20, 19.2, 17.2, 14.9, 11.6],
        ],
        max_dc_resistance=[
            *[0.5, 0.91, 1.1, 1.7, 2.6, 3.4, 4.5, 5.9, 7, 8.7, 9.7, 15.2, 22],
        ],
        trustedparts_link="https://www.trustedparts.com/en/search",
    ),
    ...
    "74439370": SeriesSpec(
        ...
        max_dc_current=[
            *[33.8, 29.7, 29.6, 25.3, 31.35, 19.6, 14.7, 13.35, 10.8],
        ],
        max_dc_resistance=[
    ...
    "74439323": SeriesSpec(
        ...
        max_dc_current=[
            *[23.7, 20, 14.5, 12.7, 12.6, 10.8, 10.2, 8.6, 8.4, 6.3],
        ],
        max_dc_resistance=[
            *[2.44, 3.78, 6.69, 8, 9.63, 11, 13.44, 16.08, 23.52],
        ],
        trustedparts_link="https://www.trustedparts.com/en/search",
    ),
    "74439324": SeriesSpec(
    ...
    "744393445": SeriesSpec(
        ...
        max_dc_resistance=[
            ...
            *[103, 15.4, 21, 24.1, 28, 38, 44, 53, 72, 77],
        ],
        trustedparts_link="https://www.trustedparts.com/en/search",
    ),
    ...
    "74437336": SeriesSpec(
        ...
        max_dc_current=[
            *[15, 10.8, 10.2, 7.4, 7.5, 7.7],
            *[7, 5.55, 3.85, 3.85, 2.9, 2.8],
        ],
        max_dc_resistance=[
            *[0.005, 0.0074, 0.012, 0.014, 0.016, 0.025],
            *[0.035, 0.038, 0.053, 0.063, 0.0762, 0.128],
        ],
        trustedparts_link="https://www.trustedparts.com/en/search",
    ),
}
