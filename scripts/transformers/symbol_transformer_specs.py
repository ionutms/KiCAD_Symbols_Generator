...
SYMBOLS_SPECS: dict[str, SeriesSpec] = {
    ...
    "HM1331NL": SeriesSpec(
        ...
        pin_config=SidePinConfig(
            left=[
                PinConfig("1", -2.54, 17.78, "passive", 2.54),
                PinConfig("2", -2.54, 10.16, "passive", 2.54),
                PinConfig("3", -2.54, 2.54, "passive", 2.54),
                PinConfig("4", -2.54, 5.08, "no_connect", 2.54, True),
                PinConfig("5", -2.54, 7.62, "no_connect", 2.54, True),
                PinConfig("6", -2.54, -7.62, "no_connect", 2.54, True),
                PinConfig("7", -2.54, -5.08, "no_connect", 2.54, True),
                PinConfig("8", -2.54, -2.54, "passive", 2.54),
                PinConfig("9", -2.54, -10.16, "passive", 2.54),
                PinConfig("10", -2.54, -17.78, "passive", 2.54),
            ],
            right=[
                PinConfig("20", 2.54, 12.7, "passive", 2.54),
                PinConfig("19", 2.54, 5.08, "passive", 2.54),
                PinConfig("18", 2.54, 7.62, "passive", 2.54),
                PinConfig("17", 2.54, 17.78, "no_connect", 2.54, True),
                PinConfig("16", 2.54, 15.24, "no_connect", 2.54, True),
                PinConfig("15", 2.54, -2.54, "no_connect", 2.54, True),
                PinConfig("14", 2.54, -5.08, "no_connect", 2.54, True),
                PinConfig("13", 2.54, -7.62, "passive", 2.54),
                PinConfig("12", 2.54, -15.24, "passive", 2.54),
                PinConfig("11", 2.54, -12.7, "passive", 2.54),
            ],
        ),
    ),
}
