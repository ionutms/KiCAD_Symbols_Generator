"""Coupled inductors Database Page.
...
database of coupled inductors, with features for customizing the view and
...
ABOUT = (
    "The coupled inductors Database is an interactive web application that "
    "provides a comprehensive view of inductor specifications.",
    "It allows users to easily browse, search, and filter "
    f"through a database of {total_rows:,} coupled inductors, "
...
usage_steps = [
    "Navigate to the coupled inductors Database page",
    "Use the table's built-in search functionality "
    "to find specific coupled inductors",
