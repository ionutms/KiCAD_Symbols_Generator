"""Dash page module for the IC Analog Devices database interface.

This module provides an interactive web interface for exploring and filtering
IC Analog Devices specifications. It includes features such as:
...
dataframe: pd.DataFrame = pd.read_csv("data/UNITED_IC_ADI.csv")
total_rows = len(dataframe)

TITLE = f"Analog Devices Integrated Circuits Database ({total_rows:,} items)"
ABOUT = (
    "The Analog Devices IC Database is an interactive web application that "
    "provides a comprehensive view of Analog Devices' integrated circuits "
...
usage_steps = [
    "Navigate to the Analog Devices IC Database page",
