...
a database of solder jumpers, with features for customizing the view and
accessing detailed information.

Key features:
- Interactive DataTable displaying solder jumpers specifications
...
- Direct links to solder jumpers datasheets
...
ag_grid_data: pd.DataFrame = pd.read_csv("data/UNITED_SOLDER_JUMPERS.csv")
...
ABOUT = (
    ...
    f"through a database of {total_rows:,} solder jumpers, "
...
usage_steps = [
    "Navigate to the solder jumpers Database page",
    "Use the table's built-in search functionality "
    "to find specific solder jumpers",
