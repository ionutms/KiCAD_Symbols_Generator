"""Dash page module for the IC Nexperia database interface.

This module provides an interactive web interface for exploring and filtering
IC Nexperia specifications. It includes features such as:
...
register_page(__name__, name=link_name, order=20)

ag_grid_data: pd.DataFrame = pd.read_csv("data/UNITED_IC_NEXPERIA.csv")
total_rows = len(ag_grid_data)

TITLE = f"Nexperia Integrated Circuits Database ({total_rows:,} items)"
ABOUT = (
    "The Nexperia IC Database is an interactive web application "
    "that provides a comprehensive view of Nexperia "
...
features = [
    ...
    "Direct links to official Nexperia datasheets and documentation",
...
usage_steps = [
    "Navigate to the Nexperia IC Database page",
