"""Dash page module for the IC Microchip database interface.

This module provides an interactive web interface for exploring and filtering
IC Microchip specifications. It includes features such as:
...
ag_grid_data: pd.DataFrame = pd.read_csv("data/UNITED_IC_MICROCHIP.csv")
total_rows = len(ag_grid_data)

TITLE = f"Microchip Integrated Circuits Database ({total_rows:,} items)"
ABOUT = (
    "The Microchip IC Database is an interactive web application "
    "that provides a comprehensive view of Microchip "
...
features = [
    ...
    "Direct links to official Microchip datasheets and documentation",
...
usage_steps = [
    "Navigate to the Microchip IC Database page",
