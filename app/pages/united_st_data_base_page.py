"""Dash page module for the IC ST database interface.

This module provides an interactive web interface for exploring and filtering
IC ST specifications. It includes features such as:
...
ag_grid_data: pd.DataFrame = pd.read_csv("data/UNITED_IC_ST.csv")
total_rows = len(ag_grid_data)

TITLE = f"ST Integrated Circuits Database ({total_rows:,} items)"
ABOUT = (
    "The ST IC Database is an interactive web application that "
    "provides a comprehensive view of ST's integrated circuits "
...
features = [
    ...
    "Direct links to official ST datasheets and documentation",
...
usage_steps = [
    "Navigate to the ST IC Database page",
