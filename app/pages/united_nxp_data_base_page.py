"""Dash page module for the IC NXP database interface.

This module provides an interactive web interface for exploring and filtering
IC NXP specifications. It includes features such as:
...
ag_grid_data: pd.DataFrame = pd.read_csv("data/UNITED_IC_NXP.csv")
total_rows = len(ag_grid_data)

TITLE = f"NXP Integrated Circuits Database ({total_rows:,} items)"
ABOUT = (
    "The NXP IC Database is an interactive web application "
    "that provides a comprehensive view of NXP "
...
features = [
    ...
    "Direct links to official NXP datasheets and documentation",
...
usage_steps = [
    "Navigate to the NXP IC Database page",
